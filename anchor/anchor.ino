...
char anchor_addr[] = "81:00:5B:D5:A9:9A:E2:9C"; //#4 chang the first two bumber to 81 82 83 84

 

//calibrated Antenna Delay setting for this anchor

uint16_t Adelay = 16460; // four achors has four different delay, so we have to chagne the value for each anchor
